...
export const contentCreators = [
  ...
  },
  {
    ...
    quote:
      "DJ und Gamer mit Leib und Seele. Ich liebe es zu Entertainen. Egal wie ❤️😇",
    color: "#9735f2",
    socials: [
      {
        icon: Twitch,
        url: "https://www.twitch.tv/zockenderdjay",
        label: "Twitch DJ",
      },
      {
        icon: Twitch,
        url: "https://www.twitch.tv/zockenderdjay_gaming",
        label: "Twitch Gaming",
      },
      {
        icon: Youtube,
...
export const members = [
  ...
  },
  {
    ...
    socials: [
      {
        icon: CodeIcon,
        url: "https://github.com/SLINIcraftet204",
        label: "Github",
      },
      {
        icon: Twitch,
        url: "https://www.twitch.tv/slini204",
        label: "Twitch",
      },
      {
        icon: Globe,
        url: "https://slinicraftet204.de",
        label: "Website",
      },
    ],
  },
